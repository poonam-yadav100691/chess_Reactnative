...
export const PIECES: Pieces = {
  br: require("../assets/chess_piece_2_black_rook.png"),
  bp: require("../assets/chess_piece_2_black_pawn.png"),
  bn: require("../assets/chess_piece_2_black_knight.png"),
  bb: require("../assets/chess_piece_2_black_bishop.png"),
  bq: require("../assets/chess_piece_2_black_queen.png"),
  bk: require("../assets/chess_piece_2_black_king.png"),
  wr: require("../assets/chess_piece_2_white_rook.png"),
  wn: require("../assets/chess_piece_2_white_knight.png"),
  wb: require("../assets/chess_piece_2_white_bishop.png"),
  wq: require("../assets/chess_piece_2_white_queen.png"),
  wk: require("../assets/chess_piece_2_white_king.png"),
  wp: require("../assets/chess_piece_2_white_pawn.png"),
};
